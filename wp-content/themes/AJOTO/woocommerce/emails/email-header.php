...
$wrapper = "
	background: " . esc_attr( $bg ) . " url('http://www.ajoto.com/maintenance/images/main_bg.gif') repeat;
	width:100%;
                	...
                	<td align="center" valign="top">
                		<?php
                			if ( $img = get_option( 'woocommerce_email_header_image' ) ) {
                				echo '<p style="margin-top:0;"><img style="width:150px;" src="' . esc_url( $img ) . '" alt="' . get_bloginfo( 'name' ) . '" /></p>';
                			}
                		?>
