...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table my_account_orders" cellspacing="20">
			...
			foreach ( $customer_orders as $customer_order ) {
				...
				?><tr class="order">
					...
					<td class="order-total">
						<strong id="<?php echo $order->order_total; ?>"><?php echo sprintf( _n( '%s for %s item', '%s for %s items', $item_count, 'woocommerce' ), $order->get_formatted_order_total(), $item_count ); ?></strong>
					</td>
