...
?>
<h3><?php _e( 'Your Order Summary', 'woocommerce' ); ?></h3>
				...
				echo '
					<tr class = "' . esc_attr( apply_filters( 'woocommerce_order_table_item_class', 'order_table_item', $item, $order ) ) . '">
						<td class="product-name">' .
							apply_filters( 'woocommerce_order_table_product_title', $_product->post->post_title, $item );
...
<dl class="customer_details">
				<p><?php _e( 'Contact Details', 'woocommerce' ); ?></p>
<?php
...
<div class="col2-set addresses order">
