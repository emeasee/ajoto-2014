...
<div id="content" class="page">
		...
		<section class="title mid subhead">
			<p>THE PEN<span>Making a mark represents the first step on the journey from good idea to great endeavour</span></p>
		</section>
	...
	<section class="screen sans-serif">
		<div class="card cube shop">
			...
			<a href="../shop/#pen">The Pen from £126</a>
			<span>CLICK HERE TO SHOP</span>
		</div>
		<div class="card three grey">
			<p><i><span class="top">MAKE YOUR MARK</span>We wanted to do justice to the most important tool we use everyday. That’s why we created a pen that not only has a great story but marks the beginning of a journey that will last a lifetime.
			</i></p>
		</div>
	</section>
	...
	<section class="screen">
		...
		<div class="card quart grey mid">
			...
			<p><i>We set out to create the only Pen you’ll ever need. Minimising complexity and focusing on quality, each of the Pen’s seven key components has a unique purpose.
	...
	<section class="screen">
		...
		<div class="card three grey">
			<p><i><span class="top">PRECISION MANUFACTURE</span>Each component of The Pen is manufactured to the highest standards in the UK, Germany and Portugal. From the farmer who hand strips cork bark to the engineer who meticulously programmes each CNC machine, it is their combined knowledge and passion that makes The Pen unique.
			</i></p>
		</div>
	</section>
