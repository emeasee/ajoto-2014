		...
		<section class="title small">
			...
			<section class="listings" style="margin-bottom:70px;">
				<section class="title mid" id="pen">
					<p>THE PEN<span>WE WANTED TO DO JUSTICE TO THE MOST IMPORTANT TOOL WE USE EVERYDAY. THAT’S WHY WE CREATED A PEN THAT NOT ONLY HAS A GREAT STORY BUT MARkS THE BEGINNING OF A JOURNEY THAT WILL LAST A LIFETIME.<br><br>EACH PEN COMES WRAPPED IN AN ANODISED ALUMINIUM BOX WITH A MOULDED CORk TRAY.</span><a href="http://dev.ajoto.com/products/the-pen" class="button">FIND OUT MORE</a></p>
				</section>

				<div id="pen"><?php echo do_shortcode( '[products skus="MYM001SP,MYM001RAWP,MYM001BP,MYM001BRP" orderby="date" order="desc"]' ); ?></div>

				<section class="title mid" id="refills">
					<p>INK REFILLS<span>A PEN IS ONLY AS GOOD AS THE qUALITY OF THE INk IT USES. WE WORk WITH ONE OF THE WORLD’S FINEST REFILL MANUFACTURERS IN THE WORLD TO ENSURE OUR INk IS OF THE HIGHEST STANDARD.</span><a href="http://dev.ajoto.com/products/the-pen" class="button">FIND OUT MORE</a></p>
				...
				<section class="title mid" id="wallet">
					<p>THE WALLET<span>THE WALLET IS A SIMPLE, TRUSTWORTHY COMPANION THAT CONTAINS THE kEYS TO YOUR WORLD. HANDMADE IN THE Uk FROM TUSCAN LEATHER, WHICH IS VEGETABLE TANNED USING TRADITIONAL PROCESSES DATING BACk 3000 YEARS.</span><a href="http://dev.ajoto.com/products/the-wallet" class="button">FIND OUT MORE</a></p>
				</section>
